...
In this example we use the trace method of the StringVar class to listen 
for changes and update the ViewModel accordingly.

The property full_name_ronly is read-only and is updated automatically
 by lisening to changes in the name and age fields.
